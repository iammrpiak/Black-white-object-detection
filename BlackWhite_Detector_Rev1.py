...
canvas1=tk.Canvas(GUI,width=300, height=320, bg='light blue')
canvas1.place(x=0,y=100)

canvas2=tk.Canvas(GUI,width=300, height=320, bg='light blue')
...
###thresh bar frame
frame_2 = tk.Frame(GUI, width=300, height=100, bg='pink')
...
def update_img():
    ...
    try:
        ...
        if blackPixels>A_Min_bar and blackPixels<A_Max_bar:
            NG_text = 'NG'
...
A_Min0 = tk.Scale(frame_2, label="Pixel_Lo-limit", from_=10, to=20000, orient=HORIZONTAL,font=Font2, variable=var2)
A_Min0.set(200)
A_Min0.place(x=150, y=0, width=W)

A_Max0 = tk.Scale(frame_2, label="Pixel_Hi-limit", from_=10, to=30000, orient=HORIZONTAL,font=Font2, variable=var8)
A_Max0.set(200)
A_Max0.place(x=150, y=50, width=W)
...
H2 = tk.Scale(frame_3, label="H2", from_=251, to=1200, orient=VERTICAL, font=Font3,variable=var4)
H2.set(640)
H2.place(x=10, y=130)
...
W2 = tk.Scale(frame_3, label="W2", from_=251, to=1500, orient=VERTICAL,font=Font3, variable=var6)
W2.set(720)
W2.place(x=90, y=130)
